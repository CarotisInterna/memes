...
class MainTabActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navbar.setOnNavigationItemSelectedListener { openFragment(it.itemId, navbar) }
        openFragment(R.id.action_meme_list, navbar)
    }

    private fun openFragment(itemId: Int, navbar: BottomNavigationView): Boolean {
        return if (itemId != R.id.action_new_meme) {
            ...
            val newMemeActivityIntent = Intent(this, NewMemeActivity::class.java)
            startActivity(newMemeActivityIntent)
            false
        }
    }
}